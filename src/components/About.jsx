        ...
        <>
            <div className="max-w-4xl mx-auto p-6 bg-white shadow-md dark:bg-gray-600 dark:text-gray-200">
                ...
                <p className="mb-4 text-gray-700 dark:text-gray-200">
                    Dictle is an innovative lightweight dictionary app designed
                    to provide users with a comprehensive and user-friendly tool
                    for enhancing their vocabulary and understanding of the
                    English language. Whether you're a student, writer, or just
                    someone with a passion for words, Dictle is the perfect
                    companion to help you find the meanings, synonyms, antonyms,
                    and usage examples for any word you encounter.
                </p>
                <p className="mb-4 text-gray-700 dark:text-gray-200">
                    Dictle is built with simplicity and efficiency in mind. With
                    a clean and intuitive interface, Dictle ensures that you can
                    quickly find the information you need without any hassle.
                    Whether you're writing an essay, drafting a novel, or simply
                    trying to understand a new word you've come across, Dictle
                ...
                <p className="mb-4 text-gray-700 dark:text-gray-200">
                    The goal is to provide you with a powerful tool that makes
                    learning new words enjoyable and accessible. Whether you're
                    looking to impress with your eloquence or simply trying to
                    avoid misunderstandings, Dictle is your go-to resource for
